    ...
    <div className='main-dashboard'>             
      ...
      <div className="content-area">
        <div className='quick-nav'>
          <Link className="nav-logo" to="/officer"><img src={require('../../assets/dashboard.png')} alt="" /></Link>
          <Link className="nav-logo" to="/officer/maps"><img src={require('../../assets/maps.png')} alt="" /></Link>
          <Link className="nav-logo" to="/officer/doc-upload"><img src={require('../../assets/upload.png')} alt="" /></Link>
          <Link className="nav-logo" to="/officer/dss"><img src={require('../../assets/dss.png')} alt="" /></Link>
          <Link className="nav-logo" to="/officer/profile"><img src={require('../../assets/profile.png')} alt="" /></Link>
