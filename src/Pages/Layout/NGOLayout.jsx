    ...
    <div className='main-dashboard'>             
      ...
      <div className="content-area">
        <div className='quick-nav'>
          <Link className="nav-logo" to="/ngo"><img src={require('../../assets/dashboard.png')} alt="" /></Link>
          <Link className="nav-logo" to="/ngo/dss"><img src={require('../../assets/dss.png')} alt="" /></Link>
          <Link className="nav-logo" to="/ngo/profile"><img src={require('../../assets/profile.png')} alt="" /></Link>
