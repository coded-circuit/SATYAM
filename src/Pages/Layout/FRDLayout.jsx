...
export default function FRDLayout({ children }) {
    ...
    <div className='main-dashboard'>             
      ...
      <div className="content-area">
        <div className='quick-nav'>
          <Link className="nav-logo" to="/frd"><img src={require('../../assets/dashboard.png')} alt="" /></Link>
          <Link className="nav-logo" to="/frd/maps"><img src={require('../../assets/maps.png')} alt="" /></Link>
          <Link className="nav-logo" to="/frd/profile"><img src={require('../../assets/profile.png')} alt="" /></Link>
